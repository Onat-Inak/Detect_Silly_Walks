...
%changes filenames of training data in convention of group8 to the naming
%convention specified for the MM project
...
for id = 1:length(files)
    ...
    [~, f] = fileparts(files(id).name);
     ...
     prev_Walk_number= num2str(str2num(prev_Walk_number)-401)
     %construct new name
